...
simplify <- function(allnames, allpowers, coefficients) {
    .Call(`_skimpy_simplify`, allnames, allpowers, coefficients)
}

mvp_prod <- function(allnames1, allpowers1, coefficients1, allnames2, allpowers2, coefficients2) {
    .Call(`_skimpy_mvp_prod`, allnames1, allpowers1, coefficients1, allnames2, allpowers2, coefficients2)
}

mvp_add <- function(allnames1, allpowers1, coefficients1, allnames2, allpowers2, coefficients2) {
    .Call(`_skimpy_mvp_add`, allnames1, allpowers1, coefficients1, allnames2, allpowers2, coefficients2)
}

mvp_power <- function(allnames, allpowers, coefficients, n) {
    .Call(`_skimpy_mvp_power`, allnames, allpowers, coefficients, n)
}

mvp_deriv <- function(allnames, allpowers, coefficients, v) {
    .Call(`_skimpy_mvp_deriv`, allnames, allpowers, coefficients, v)
}
